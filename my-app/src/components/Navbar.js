        ...
        <Container maxW='full' pos="sticky" top={ 0 } zIndex={ 2 } boxShadow='md' rounded='md' bg='white' >
            ...
            <Flex justify='space-between' p='3' w='96%' m='auto'>
                ...
                <HStack spacing='24px' >
                    ...
                    <Box>
                        <Link to='/about' _activeLink={ { color: 'blue.600', fontSize: '1.2rem', letterSpacing: '1px' } } as={ NavLink } >Login</Link>
                    </Box>

                    <Box>
                        <Link to='/cart' _activeLink={ { color: 'blue.600', fontSize: '1.2rem', letterSpacing: '1px' } } as={ NavLink } >Cart</Link>
                    </Box>
